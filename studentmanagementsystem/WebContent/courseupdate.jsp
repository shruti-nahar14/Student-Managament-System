         ...
         while(rs.next())
         {
          ...
          <div>
            ...
            <div>
                 ...
                 <input type="text" id="name" name="name"class="form-control" value="<%=rs.getString("coursename")%>" required>
            </div>
            <br>
            <div>
                 <label class="form-label">Duration</label>
                 <input type="text" id="duration" name="duration"  class="form-control" value="<%=rs.getString("duration")%>" required>
            </div>
            <br>
            <div>
